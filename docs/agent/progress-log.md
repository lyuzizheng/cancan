...
- Continue `vault-manual-import` with Keychain remembering, recovery-file, system sleep/lock, statement-password, `Save a copy`, non-PDF viewing, and safe source display/list checkpoints. Keep automatic Inbox/Gmail tombstone suppression in their later owning slices.
