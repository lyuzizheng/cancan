...
3. `docs/agent/iteration-protocol.md`
4. `docs/agent/consistency-checklist.md`
5. The feature-specific product/architecture docs touched by the task
...
3. ADRs in `docs/adr/` for accepted architecture decisions.
4. Product/architecture docs in `docs/00-*.md` through `docs/11-*.md`.
5. Existing code behavior, only when docs are silent.
...
Do not put large design essays here. Put product design in the numbered docs and use this folder as the working memory layer.
