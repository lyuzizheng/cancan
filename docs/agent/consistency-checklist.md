...
- [ ] Did `docs/agent/progress-log.md` get a dated entry when a product decision, implementation scope, or architecture assumption changed (otherwise the PR body is the record)?
