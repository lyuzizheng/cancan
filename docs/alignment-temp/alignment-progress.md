...
| Local Inbox filesystem readiness | blocked | Prove the stable-file pre/post-read protocol, deletion suppression, restart recovery, and cloud-placeholder behavior against an ordinary local folder and the supported iCloud Drive path; choose the settle interval from evidence rather than user configuration | `docs/specs/0017-evidence-documents-source-ux.md`, `docs/specs/0016-testing-fixtures-agent-gates.md` |
