...
export const Input = forwardRef<HTMLInputElement, InputProps>(function Input(
  ...
  return (
    <input
      className={cx(
        "h-8 w-full rounded-sm border border-ledger-rule bg-ledger-porcelain px-2.5 text-sm text-ledger-ink transition-colors duration-120 ease-mech placeholder:text-ledger-text-muted",
