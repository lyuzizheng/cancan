...
9. If docs or harness files changed, run the independent semantic gate in `.agents/docs-semantic-review.md`.
10. Report what changed, what was verified, and what remains.
